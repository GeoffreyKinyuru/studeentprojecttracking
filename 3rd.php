...
$Select_Query="SELECT regno,fname,sname,registration.year, projects.projecttitle FROM registration,projects WHERE registration.studentID=projects.studentID AND registration.year = 3  AND projects.year= 3";
...
<head>
  ...
  <title>3rd Years @ MMUST Student Project Tracking System</title>
        ...
        <div class="col-xs-12">
          ...
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">3RD YEAR STUDENTS WHO HAVE REGISTERED THEIR PROJECTS</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
