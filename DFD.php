...
<head>
  ...
  <title>DFDs Approval @ MMUST Student Project Tracking System</title>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">DFDs Approval</li>
      </ol>
    </section>
  ...
  <strong>Success!</strong></div>";
		  ...
		  ?>
            <div class="box-header">
              <h3 class="box-title">DFDs APPROVAL SECTION</h3>
            </div>
            <!-- /.box-header -->
...
function myFunction2(){
	...
	for (i = 1; i < myTable.rows.length; i++) {
		...
		var reg2D = document.getElementById('example1').rows[1].cells.item(0).innerHTML;

			window.location.href = "DFD.php?w12D="+reg2D ;
...
function decline(){
	...
	for (i = 1; i < decline.rows.length; i++) {
		...
		var reg2 = document.getElementById('example1').rows[1].cells.item(0).innerHTML;

			window.location.href = "DFD.php?w12="+reg2 ;
}
