...
$Select_Query="SELECT registration.regno,registration.fname,registration.sname,registration.year,projects.projecttitle,projects.status FROM registration,projects WHERE registration.studentID=projects.studentID AND registration.year = projects.year  ";
...
<head>
  ...
  <title>Concepts Approval @ MMUST Student Project Tracking System</title>
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            ...
            <li><a href="progrss.php"><i class="fa fa-circle-o"></i> Progress Assessment</a></li>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Concept Approval</li>
      </ol>
    </section>
    ...
    <section class="content">
      ...
      <div class="row">
        <div class="col-xs-12">
		  ...
		  <?php
if(isset($_SESSION['conceptsuccess'])){
	echo "<div class='alert alert-success alert-dismissible'>
	<a href='#' class='close' data-dismiss='alert' aria-label='close'>&times;</a>
  <strong>Success!</strong></div>";
}else{}	

if(isset($_SESSION['conceptFsuccess'])){
	echo "<div class='alert alert-success alert-dismissible'>
	<a href='#' class='close' data-dismiss='alert' aria-label='close'>&times;</a>
  <strong>Success!</strong></div>";
}else{}		
            ...
            <div class="box-header">
              <h3 class="box-title">CONCEPTS APPROVAL SECTION</h3>
            </div>
            <!-- /.box-header -->
...
function decline(){
	...
	for (i = 1; i < decline.rows.length; i++) {
		...
		var reg = document.getElementById('example1').rows[1].cells.item(0).innerHTML;

			window.location.href = "conceptsApproval.php?w1="+reg ;
}
...
function myFunction2(){
	...
	for (i = 1; i < myTable.rows.length; i++) {
          ...
          var regA = document.getElementById('example1').rows[1].cells.item(0).innerHTML;

			window.location.href = "conceptsApproval.php?w1A="+regA ;
        }
