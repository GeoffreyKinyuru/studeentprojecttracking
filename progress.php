...
<head>
  ...
  <title>Progress Approval @ MMUST Student Project Tracking System</title>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Progress Approval</li>
      </ol>
    </section>
...
function myFunction2(){
	...
	var reg4G = document.getElementById('example1').rows[1].cells.item(0).innerHTML;

			window.location.href = "progress.php?w14G="+reg4G ;
}
</script>
<script>
...
function decline(){
	...
	for (i = 1; i < decline.rows.length; i++) {
		...
		var reg4 = document.getElementById('example1').rows[1].cells.item(0).innerHTML;

			window.location.href = "progress.php?w14="+reg4 ;
}
