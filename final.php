...
<head>
  ...
  <title>Final Approval @ MMUST Student Project Tracking System</title>
...
function myFunction2(){
	...
	for (i = 1; i < myTable.rows.length; i++) {
		...
		var reg5F = document.getElementById('example1').rows[1].cells.item(0).innerHTML;

			window.location.href = "final.php?w15F="+reg5F ;
...
function decline(){
	...
	for (i = 1; i < decline.rows.length; i++) {
		...
		var reg5 = document.getElementById('example1').rows[1].cells.item(0).innerHTML;

			window.location.href = "final.php?w15="+reg5 ;
}
